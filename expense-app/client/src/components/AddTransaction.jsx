    ...
    <div className='footer'>
      ...
      <div className='addTransaction'>
        ...
        <div class="form-control">
          ...
          <input type="text" name="text" onChange={(e) => setText(e.target.value)} value={text}  placeholder="description" required/>
        </div>
        <div class="form-control">
          <label for="amount"
            >Amount <br />
          ...
          >
          <input type="number" name="amount" onChange={(e)=> setAmount(e.target.value)} value={amount} placeholder="e.g -200 for expense" required/>
        </div>
